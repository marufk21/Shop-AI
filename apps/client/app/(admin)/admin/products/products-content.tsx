          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className={`h-8 px-3.5 rounded-lg text-[11px] font-semibold cursor-pointer shrink-0 transition-all duration-200 border ${masterCategory === "All"
              ...
              {masters.map((master) => {
                ...
                return (
                  <button
                    ...
                    className={`h-8 px-3.5 rounded-lg text-[11px] font-semibold cursor-pointer shrink-0 transition-all duration-200 border ${active
                      ? "bg-foreground border-foreground text-background shadow-sm"
                      : "bg-background border-border hover:border-foreground/25 hover:bg-muted/40 text-muted-foreground hover:text-foreground"
                      }`}
                  >
          ...
          {masterCategory !== "All" && visibleArticleTypes.length > 0 && (
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className={`h-7 px-3 rounded-lg text-[11px] font-semibold cursor-pointer shrink-0 transition-all duration-200 border ${articleType === "All"
              ...
              {visibleArticleTypes.map((at) => {
                ...
                return (
                  <button
                    ...
                    className={`h-7 px-3 rounded-lg text-[11px] font-semibold cursor-pointer shrink-0 transition-all duration-200 border capitalize ${active
                      ? "bg-primary/10 border-primary/30 text-primary shadow-sm"
                      : "bg-background border-border hover:border-primary/25 hover:bg-primary/5 text-muted-foreground hover:text-foreground"
                      }`}
                  >
